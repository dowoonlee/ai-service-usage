...
| 버전 | 날짜 | 주요 변경 |
|---|---|---|
| v0.3.0 | 2026-04-29 | 펫 **75종**으로 확장 (0x72 DungeonTileset II 32종 + Pixel Frog Kings/Pirates/Treasure Hunters 13종). 펫별 전용 대사·설명(개발자/CS/AI 밈 톤). 도감 미리보기 사이드 슬라이드 + 포켓몬 도감 카드(rarity 별 표시). 사용 시간 기반 이로치 해금(4d/8d/12d). 신규/레벨업 펫 NEW! 강조 표시 (직접 클릭해 확인하기 전까지 유지). 마이그레이션 시 Legendary/Epic 무료 지급 가드 |
