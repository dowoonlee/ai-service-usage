...
// 방명록 답글 (guild_guestbook_replies) — M3. 1단 깊이, 권한 = 그 길드 멤버 + 원글 작성자.
export const GUESTBOOK_REPLY_MAX_LEN = 60;                 // DB CHECK(1..60)와 쌍
export const GUESTBOOK_REPLY_COOLDOWN_SEC = 30;            // 댓글과 동일 — 대화 흐름 허용, 스팸만 차단
export const GUESTBOOK_REPLY_PREVIEW = 3;                  // 원글당 응답에 싣는 최근 답글 수 (Egress)
export const GUESTBOOK_REPLY_BADGE_WINDOW_SEC = 30 * 86400; // 방문자 배지가 보는 답글 기간
